...
public class AzureAISearchMemory : IMemoryDb
{
    ...
    private static SearchClientOptions GetClientOptions()
    {
        return new SearchClientOptions
        {
            ...
            //added retry policy
            RetryPolicy = new RetryPolicy(maxRetries: 10, delayStrategy: DelayStrategy.CreateExponentialDelayStrategy(initialDelay: TimeSpan.FromSeconds(5), maxDelay: TimeSpan.FromSeconds(60)))
        };
    }

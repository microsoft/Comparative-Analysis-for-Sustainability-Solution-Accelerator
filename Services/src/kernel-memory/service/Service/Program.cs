...
internal static class Program
{
    public static void Main(string[] args)
    {
        ...
        //adding additional config for Kestrel uploading size
        ((IWebHostBuilder)appBuilder.WebHost).UseKestrel(options =>
        {
        ...
        appBuilder.Logging.Services.AddLogging(loggingBuilder =>
        {
